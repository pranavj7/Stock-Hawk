...
import com.sam_chordas.android.stockhawk.service.DisplayToast;
...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
                  ...
                  .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(MaterialDialog dialog, CharSequence input) {
                      ...
                      // in the DB and proceed accordingly
                       String caps = input.toString().toUpperCase();
                      Cursor c = getContentResolver().query(QuoteProvider.Quotes.CONTENT_URI,
                              new String[]{QuoteColumns.SYMBOL}, QuoteColumns.SYMBOL + "= ?",
                              new String[]{caps}, null);
                      if (c.getCount() != 0) {
                        Toast toast =
                                Toast.makeText(MyStocksActivity.this,R.string.toast_saved,
                                        Toast.LENGTH_LONG);
                        ...
                        mServiceIntent.putExtra("symbol", caps);
                        startService(mServiceIntent);
                      }
                    }
                  })
  ...
  public void onEvent(DisplayToast displayToast) {
    Toast.makeText(this, displayToast.mText , Toast.LENGTH_LONG).show();
  }
}
